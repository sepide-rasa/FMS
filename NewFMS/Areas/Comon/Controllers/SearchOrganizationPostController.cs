...
{
    public class SearchOrganizationPostController : Controller
    {
        //
        // GET: /Comon/SearchOrganizationPost/
        ...
        public ActionResult Read(StoreRequestParameters parameters)
        {
            ...
            if (filterHeaders.Conditions.Count > 0)
            {
                ...
                foreach (var item in filterHeaders.Conditions)
                {
                    ...
                    if (data != null)
                        data1 = servic.GetTreeOrganPost(field, searchtext, Session["Username"].ToString(), Session["Password"].ToString(), IP, out Err).ToList();
                    else
                        data = servic.GetTreeOrganPost(field, searchtext, Session["Username"].ToString(), Session["Password"].ToString(), IP, out Err).ToList();
                }
            ...
            {
                data = servic.GetTreeOrganPost("", "", Session["Username"].ToString(), Session["Password"].ToString(), IP, out Err).ToList();
            }
