...
//            return result;
//        }
//        public ActionResult Project_Details(int ProjectId)
//        {
//            if (Session["Username"] == null)
//                return RedirectToAction("logon", "Account", new { area = "" });
...
//                    //ذخیره
//                    MsgTitle = "ذخیره موفق";
//                    Msg = BudgetService.InsertProject_Faaliyat(proj.fldTrah_KhedmatId,proj.fldCod,proj.fldTitle,1,proj.fldEtebarId,proj.fldMasrafId,proj.fldChartOrganId,proj.fldDesc, Session["Username"].ToString(), (Session["Password"].ToString()), Convert.ToInt32(Session["OrganId"]), IP, out Err);
//                }
//                else
//                {
//                    //ویرایش
//                    MsgTitle = "ویرایش موفق";
//                    Msg = BudgetService.UpdateProject_Faaliyat(proj.fldId, proj.fldTrah_KhedmatId, proj.fldCod, proj.fldTitle,1, proj.fldEtebarId, proj.fldMasrafId, proj.fldChartOrganId, proj.fldDesc, Session["Username"].ToString(), (Session["Password"].ToString()), Convert.ToInt32(Session["OrganId"]), IP, out Err);
