...
//{
//    public class SearchTarhController : Controller
//    {
//        //
//        // GET: /Budget/SearchTarh/
...
//                      }
//                      if (data != null)
//                          data1 = servic.GetTarh_KhedmatWithFilter(field, searchtext, searchtext,Convert.ToInt32(Session["OrganId"]), 100, IP, out Err).Where(l => l.fldType == 1).ToList();
//                      else
//                          data = servic.GetTarh_KhedmatWithFilter(field, searchtext, searchtext, Convert.ToInt32(Session["OrganId"]), 100, IP, out Err).Where(l => l.fldType == 1).ToList();
//                  }
...
//              else
//              {
//                  data = servic.GetTarh_KhedmatWithFilter("", "", "", Convert.ToInt32(Session["OrganId"]), 100, IP, out Err).Where(l => l.fldType == 1).ToList();
//              }
