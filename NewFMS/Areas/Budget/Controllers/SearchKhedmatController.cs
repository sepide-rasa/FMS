...
//{
//    public class SearchKhedmatController : Controller
//    {
//        //
//        // GET: /Budget/SearchKhedmat/
...
//                      }
//                      if (data != null)
//                          data1 = servic.GetTarh_KhedmatWithFilter(field, searchtext, searchtext,Convert.ToInt32(Session["OrganId"]), 100, IP, out Err).Where(l => l.fldType == 2).ToList();
//                      else
//                          data = servic.GetTarh_KhedmatWithFilter(field, searchtext, searchtext, Convert.ToInt32(Session["OrganId"]), 100, IP, out Err).Where(l => l.fldType == 2).ToList();
//                  }
...
//              else
//              {
//                  data = servic.GetTarh_KhedmatWithFilter("", "", "", Convert.ToInt32(Session["OrganId"]), 100, IP, out Err).Where(l => l.fldType == 2).ToList();
//              }
