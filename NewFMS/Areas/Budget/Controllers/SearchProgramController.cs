...
//                      }
//                      if (data != null)
//                          data1 = servic.GetProgramWithFilter(field, searchtext, searchtext,Convert.ToInt32(Session["OrganId"]), 100, IP, out Err).ToList();
//                      else
//                          data = servic.GetProgramWithFilter(field, searchtext, searchtext,Convert.ToInt32(Session["OrganId"]), 100, IP, out Err).ToList();
//                  }
...
//              else
//              {
//                  data = servic.GetProgramWithFilter("", "","", Convert.ToInt32(Session["OrganId"]), 100, IP, out Err).ToList();
//              }
